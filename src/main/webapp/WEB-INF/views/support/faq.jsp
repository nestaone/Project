    ...
    <div class="main-content-wrapper d-flex clearfix">
		...
		<div id="sup" class="flex-fill">
			...
			<ul id="navigation" class="nav nav-tabs">
			  <li class="nav-item">
			    <a class="nav-link active" aria-current="page" href="/faq">입금/결제</a>
			  </li>
			  <li class="nav-item">
			    <a class="nav-link" href="/faq2">배송</a>
			  </li>
			  <li class="nav-item">
			...
			<div class="row">
				<div class="col-md-3 type">[입금/결제]</div>
				<div class="col-md-7 faqtap">
					<ul class="faq1">
						<li class="article">
						<p class="q">입금확인은 언제되나요?</p>
						<p class="a">입금확인 내용입니다</p>
						</li>
					</ul>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-7 faqtap">
					<ul class="faq2">
						<li class="article">
						<p class="q">주문후 입금은 언제까지 해야되나요?</p>
						<p class="a">주문입금 내용입니다</p>
						</li>
					</ul>
				</div>
			</div>
