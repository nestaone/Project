...
<body>
			...
			<form action="write" method="post">
				...
				<div class="row mb-3">
					<div class="col-md-7">
					  ...
					  <input class="form-control" name="title" value="<c:out value="${content.title}"/>" readonly="readonly">
				  	</div>
				  	<div class="col-md-5">
				  	 <label for="writer" class="form-label">작성자</label>
				  	<input class="form-control" name="writer" value="<c:out value="${content.writer}"/>" readonly="readonly">
					</div>
				</div>
				<div class="mb-3">
				  <label for="content" class="form-label">내용</label>
				  <textarea class="form-control" name="content" rows="5" readonly="readonly"><c:out value="${content.content}"/></textarea>
				</div>
				<div class="float-right mr-3">
					<button type="button" id="modify" class="btn btn-outline-info">수정</button>
    ...
    <script>
    	...
    	$('#modify').click(function(){
    		$(location).attr("href","/modifyno?bno="+<c:out value="${content.bno}"/>)
    	});
    	$('#delete').click(function(){
    		$(location).attr("href","/delete?bno="+<c:out value="${content.bno}"/>)
    	});
    </script>
