...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
		...
		<div id="sup" class="flex-fill">
			...
			<h4 id="title" class="text-center">공지사항</h4>
				...
				<tbody>
					<c:forEach var="notice" items="${notice}">
	                    <tr>
	                   		...
	                   		<td><a href="read?bno=<c:out value='${notice.bno}'/>"><c:out value="${notice.title}"/></a></td>
			...
			<div class="float-right" style="margin-right: 20px">
				<button id="post" type="button" class="btn btn-outline-info btn-sm">글쓰기</button>
			</div>
    ...
    <script>
    	...
    	$('#post').css("cursor","pointer").click(function(){
