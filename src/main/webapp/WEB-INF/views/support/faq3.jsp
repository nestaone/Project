    ...
    <div class="main-content-wrapper d-flex clearfix">
		...
		<div id="sup" class="flex-fill">
			...
			<ul id="navigation" class="nav nav-tabs">
			  ...
			  <li class="nav-item">
			    <a class="nav-link active" href="/faq3">반품/교환</a>
			  </li>
			</ul>
			<br>
			
			<div class="row">
				<div class="col-md-3 type">[반품/교환]</div>
				<div class="col-md-7 faqtap">
					<ul class="faq1">
						<li class="article">
						<p class="q">반품&교환은 어떻게 하나요?</p>
						<p class="a">반품&교환 내용입니다</p>
						</li>
					</ul>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-7 faqtap">
					<ul class="faq2">
						<li class="article">
						<p class="q">반품&교환시 배송비는 얼마인가요?</p>
						<p class="a">반품&교환 배송비 내용입니다</p>
						</li>
					</ul>
				</div>
			</div>
